    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative z-10 my-20">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-xs text-center text-green-100 flex items-center space-x-4 max-w-lg">
          ...
          <TextGenerateEffect
            ...
            words="Your Journey to Financial Freedom"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Achieve your goals with a platform designed for traders of all levels.
          </p>
          <a href="#">
